  ...
  if (notFound) {
    return (
      <div className="min-h-screen">
        <Topbar title="Edit Island" />
        <div className="px-8 py-12 text-center">
          <p className="text-[#8a7f6e] text-lg" style={{ fontFamily: "'Nunito', sans-serif" }}>
            Island not found.
          </p>
          <Link to="/islands" className="mt-4 inline-block">
            <Button variant="secondary">← Back to Islands</Button>
          </Link>
        </div>
      </div>
    );
      ...
      <div className="px-8 py-6 max-w-2xl">
        ...
        >
          ...
          <p className="text-sm text-[#8a7f6e] mb-6" style={{ fontFamily: "'Nunito', sans-serif" }}>
            Update the details for island <span className="font-mono font-bold">{id}</span>.
          </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  style={{ ...inputStyle, background: '#eeeae0' }}
                />
